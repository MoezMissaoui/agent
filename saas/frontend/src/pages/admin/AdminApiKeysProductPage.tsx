              ...
              return (
                ...
                >
                            ...
                            >
                              ...
                              <div className="flex shrink-0 flex-wrap gap-1.5">
                                <button
                                  ...
                                  className="rounded-lg px-2 py-1 text-xs font-medium text-primary transition hover:bg-primary/10 disabled:opacity-50 dark:hover:bg-primary/15"
                                  onClick={() => void onCopyToken(agent.agentId, t.identifier)}
                                >
                                  {copySubmitting[ck] ? 'Copying…' : 'Copy'}
                                </button>
                                <button
                                  type="button"
                  ...
                  <p className="mt-3 text-xs text-slate-400 dark:text-slate-500">
                    Assistant updated {formatShortDate(agent.updatedAt)}
                  </p>
